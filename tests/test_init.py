...
async def test_setup_entry(hass: HomeAssistant, mock_config_entry: MockConfigEntry):
    ...
    with patch("custom_components.gree_versati.client.GreeVersatiClient") as mock_client_class:
...
async def test_setup_entry_fails_cannot_connect(hass: HomeAssistant, mock_config_entry: MockConfigEntry):
